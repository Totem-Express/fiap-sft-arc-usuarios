...
class UserTest {
    ...
    void should_create_user_with_all_fields() {
        ...
        User user = new User(id, "Name Name", "email@email.com", "114.974.750-15", createdAt, Role.USER);
    ...
    class Validations{
        ...
        void should_not_create_user_with_invalid_name(String name) {
            ...
            assertThatExceptionOfType(InvariantException.class)
                    .isThrownBy(() -> new User(UUID.randomUUID().toString(), name, "email@email.com", "114.974.750-15", LocalDateTime.now(), Role.USER))
                    .withMessageContaining("User name must be not blank");
        ...
        void should_not_create_user_with_invalid_email(String email) {
            ...
            assertThatExceptionOfType(InvariantException.class)
                    .isThrownBy(() -> new User(UUID.randomUUID().toString(), "name", email, "114.974.750-15", LocalDateTime.now(), Role.USER))
                    .withMessageContaining("User email must be not blank");
        ...
        void should_not_create_user_with_invalid_blank_cpf(String cpf) {
            ...
            assertThatExceptionOfType(InvariantException.class)
                    .isThrownBy(() -> new User(UUID.randomUUID().toString(), "name", "email@email.com", cpf, LocalDateTime.now(), Role.USER))
                    .withMessageContaining("User cpf must be not blank");
        ...
        void should_not_create_user_without_role() {
            assertThatExceptionOfType(InvariantException.class)
                    .isThrownBy(() -> new User(UUID.randomUUID().toString(), "name", "email@email.com", "114.974.750-15",  LocalDateTime.now(), null))
        ...
        void should_not_create_user_without_created_at() {
            assertThatExceptionOfType(InvariantException.class)
                    .isThrownBy(() -> new User(UUID.randomUUID().toString(), "name", "email@email.com", "114.974.750-15", null, Role.USER))
