...
class UserGatewayImplTest {
    ...
    void should_create_user() {
        User user = new User(UUID.randomUUID().toString(), "Brad Pitt", "bradpitt@email.com", "114.974.750-15", LocalDateTime.now(), ADMIN);
    ...
    void should_find_all_users() {
        UserEntity userEntity1 = new UserEntity(new User(UUID.randomUUID().toString(), "Brad Pitt", "bradpitt@email.com", "114.974.750-15", LocalDateTime.now(), USER));
        UserEntity userEntity2 = new UserEntity(new User(UUID.randomUUID().toString(), "Angelina Jolie", "angelina@email.com", "936.038.500-09", LocalDateTime.now(), ADMIN));
    ...
    void should_check_if_user_exists_by_id() {
        ...
        boolean exists = userGateway.existsById(id);
    ...
    void should_find_user_by_id() {
        String id = UUID.randomUUID().toString();
        UserEntity userEntity = new UserEntity(new User(UUID.randomUUID().toString(), "Brad Pitt", "bradpitt@email.com", "114.974.750-15", LocalDateTime.now(), USER));
